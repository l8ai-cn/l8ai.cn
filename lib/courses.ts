...
export const courses: Course[] = [
  ...
  },
  {
    ...
    duration: "5 天实验课",
    level: "专业",
    outcome: "完成 Doops、DoAgent、DoDNS、DoSecurity、DoProject 支撑的 AI 应用发布、诊断、安全和交付流程。",
    pageTitle: "Do Engineering Tools Lab",
    summary: "围绕 Doops、DoAgent、DoDNS、DoSecurity、DoProject 建立部署、执行、入口治理、安全审计和项目交付的工程能力。",
    modules: [
    ...
    tools: ["Doops", "DoAgent", "DoDNS", "DoSecurity", "DoProject", "Kubernetes", "Ingress"],
  },
  {
