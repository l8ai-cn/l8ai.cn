  ...
  return (
    <>
      <button
        ...
        className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-primary text-primary-foreground shadow-[0_12px_30px_rgba(0,87,230,0.4)] transition-transform hover:scale-105 active:scale-95"
      >
            ...
            {messages.length === 0 && (
              <div className="space-y-4">
                <div className="rounded-xl rounded-tl-sm bg-muted px-3 py-2.5 text-sm text-foreground">
                  你好，我是来八助手。关于 L8AI 的 8L 产品、6L 方法论、3Do 工具或课程，都可以问我。
                </div>
